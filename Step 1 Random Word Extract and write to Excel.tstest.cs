...
namespace Data_Dancing
{
    ...
    public class Step_1_Random_Word_Extract_and_write_to_Excel : BaseWebAiiTest
    {
        ...
        public void Step_1_Random_Word_Extract_and_write_to_Excel_CodedStep()
        {
            ...
            string myPath = "C:\\My Documents\\Test Studio Projects\\Data Dancing\\Data\\domainResults.xlsx";
                        ...
                        {
                            excelApp.Cells[Data.IterationIndex + 3 , 3] = Data["RandomWord1"];
                           // excelApp.Cells[Data.IterationIndex + 2 , 3] = Data["RandomWord1"];
